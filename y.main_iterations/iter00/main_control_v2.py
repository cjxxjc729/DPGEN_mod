...
if __name__ == "__main__":
    ...
    step_name = "01.exploration"
    if not os.path.exists(step_name+"/"+"end.signal"):
        run_step(step_name, iter01_mode = (current_iter == 'iter01'))

    step_name = "02.selection"
    if not os.path.exists(step_name+"/"+"end.signal"):
        run_step(step_name, iter01_mode = (current_iter == 'iter01'))

    step_name = "03.labelling"
    if not os.path.exists(step_name+"/"+"end.signal"):
        run_step(step_name, iter01_mode = (current_iter == 'iter01'))

    step_name = "04.training"
    if not os.path.exists(step_name+"/"+"end.signal"):
        run_step(step_name, iter01_mode = (current_iter == 'iter01'))
